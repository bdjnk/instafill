...
Current design choices I've made are as follows: The nodes only replace "air" nodes. The two corner nodes must be placed deliberately, and not be the second corner node of a previous instafill. While the two initial nodes must come from your inventory, the rest are magically generated.
